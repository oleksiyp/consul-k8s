...
func TestRun_ACLReplicationTokenValid(t *testing.T) {
	...
	retry.Run(t, func(r *retry.R) {
		...
		require.Greater(t, replicationStatus.ReplicatedIndex, uintZero)
	})
...
// up resources.
func completeReplicatedSetup(t *testing.T, prefix string, bootToken string) (*fake.Clientset, *api.Client, func()) {
	t.Helper()
